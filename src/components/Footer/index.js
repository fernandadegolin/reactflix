  ...
  return (
    <FooterBase>
      ...
      <Redes className="Redes">
        ...
        <a href="https://www.linkedin.com/in/fernandadegolin/" target="_blank">
          <img className="Linkedin" src={Linkedin} alt="Logo LinkedIn" />
        </a>
        <a href="mailto:fernandadegolin@hotmail.com" target="_blank">
          <img className="Email" src={Email} alt="Logo Email" />
        </a>
      </Redes>
      <p>
        built by{" "}
        <a href="https://fernandadegolin.github.io/fernandadegolin/">
          Fernanda Degolin - 2023
        </a>
      </p>
    </FooterBase>
  );
